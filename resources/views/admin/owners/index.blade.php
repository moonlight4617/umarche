            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="container md:px-5 mx-auto">
                    ...
                    <div class="flex justify-end mb-4">
                        <button onclick="location.href='{{ route('admin.owners.create')}}'" class="text-white bg-indigo-500 border-0 py-2 md:px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">新規登録</button>
                    </div>
                    ...
                    <table class="table-auto w-full text-left whitespace-no-wrap">
                        ...
                        <tr>
                            ...
                            <th class="md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">作作成日</th>
